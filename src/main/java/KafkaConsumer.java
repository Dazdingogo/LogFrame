...
public class KafkaConsumer {
    ...
    private static String hdfsBasicPath = "hdfs://hadoop102:9000/user/atguigu/0416/";

    public static void main(String[] args) {
        // 创建配置
        Properties properties = new Properties();
        properties.put("zookeeper.connect", "192.168.1.200:2181");
        ...
        try {
            // 获取HDFS文件系统
            fs = FileSystem.get(new URI("hdfs://hadoop102:9000"), configuration, "atguigu");
        } catch (Exception e) {
            e.printStackTrace();
        }
